...
walk_status walk_tree_fd(
    int dfd,
    const std::string& cur_path,
    const walk_callback& cb
);

walk_status process_entry(
    int parent_dfd,
    const char* name,
...
int sys::walk_tree(
    ...
    walk_entry root_entry {
        .path = std::string_view(root.full),
