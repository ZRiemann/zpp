...
public:
  ...
  /**
   * @brief Initialize the shared memory segment and construct @ref
   * ServiceStats.
   *
   ...
   * @return @c true on success, @c false if the shared memory could not be
   * created.
   */
   ...
   */
  void update_thread_pool_stats(uint32_t num_threads, uint32_t num_active,
